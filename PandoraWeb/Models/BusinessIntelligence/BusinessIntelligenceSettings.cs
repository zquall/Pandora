...
namespace PandoraWeb.Models.BusinessIntelligence
{
    public static class BusinessIntelligenceSettings
    {
        ...
        {
            PivotGridSettings settings = new PivotGridSettingsBase("BusinessIntelligence", "SalesByEmployeeByDivisionPartial");
        ...
        public static PivotGridSettings SalesByEmployeeByDivisionSettings1()
        {
            PivotGridSettings settings = new PivotGridSettingsBase("BusinessIntelligence", "SalesByEmployeeByDivisionPartial");
